...
T_PLANET = 102
T_FLEET = 103
# T_ALLIANCE = 104 not used at the moment
T_TECHNOLOGY = 105
# T_ASTEROID = 106 not used at the moment
T_NATURE = 107
T_AIPLAYER = 108
T_AIRENPLAYER = 109
T_AIMUTPLAYER = 110
...
# boundaries to use with bisect (left)
REL_BOUNDARIES = [REL_UNFRIENDLY_LO, REL_NEUTRAL_LO, REL_FRIENDLY_LO, REL_ALLY_LO]
...
PLAYER_SELECT_NEWPLAYER = 1
PLAYER_SELECT_AIPLAYER = 2
PLAYER_SELECT_PIRATE = 3
PLAYER_SELECT_CONTINUE = 4
PLAYER_SELECT_NEWSINGLE = 5
